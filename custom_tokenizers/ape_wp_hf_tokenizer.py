...
class APEWPHFTokenizer(PreTrainedTokenizerFast):
    """
    Fast APE tokenizer using HuggingFace's WordPiece implementation.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initializes the APEWPHFTokenizer.
    ...
    def create_vocabulary(self, text, append_to_existing_vocabulary=False, vocab_path=None, save_vocabulary=False):
        ...
        """
        print(f"Training APE-WP-HF tokenizer with vocab_size={self.max_vocab_size}, min_frequency={self.min_freq_for_merge}...")
        ...
        # Create WordPiece trainer with APE parameters
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        config_dict = {
            ...
            "model_type": "ape_wp_hf_tokenizer",

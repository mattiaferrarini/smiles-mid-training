...
class ElementTokenizer(PreTrainedTokenizer):
    """
    Tokenizer that splits SMILES into elements and other chemical symbols.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes the ElementTokenizer.
    ...
    def _tokenize(self, text):
        """
        Splits text into elements and other chemical symbols.
